...
* 
*/
@jakarta.annotation.Generated(value = "io.zenwave360.sdk.plugins.SpringCloudStreams3Plugin", date = "2024-01-04T07:43:57.282100622+01:00")
public interface IReceiveHelloMessageConsumerService {
     ...
     * 
     */
    default void receiveHelloMessage(HelloMessagePayload payload, HelloMessagePayloadHeaders headers) {};
